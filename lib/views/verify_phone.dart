...
class VerifyPhonePage extends StatefulWidget {
  String? flagVerify,phone,email,password,cnfPass,name,userName;
  VerifyPhonePage({Key? key,@required this.flagVerify,@required this.phone,@required this.name,
  @required this.userName,@required this.email,
  @required this.password,@required this.cnfPass}):super(key: key);
